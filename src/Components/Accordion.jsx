    ...
    return (
      <div className="w-full max-w-md mx-auto my-[5px]">
        <div className=" border-black  rounded-md">
          ...
          >
            <span className="text-md font-light  playfair-display text-black inline-flex items-center gap-[5px]">Details <FcViewDetails /></span>
            <svg
          ...
          >
            <div className="p-[5px] bg-transpaernt rounded-md backdrop-blur-md">
              <p className="text-black text-sm sm:text-sm md:text-md lg:text-lg text-start playfair-display">
                {content}
              </p>
            </div>
          </div>
